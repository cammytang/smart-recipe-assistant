...
class SummarizationService:
    ...
    def summarize_task(self, state: MenuState, task: DishItem, context: str) -> str:
    ...
    def stream_task_summary(
        self, state: MenuState, task: DishItem, context: str
    ...
    def _build_prompt(self, state: MenuState, task: DishItem, context: str) -> str:
