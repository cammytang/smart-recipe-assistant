...
class ToolCallTracker:
    ...
    # Draining helpers
    # ------------------------------------------------------------------
    def drain(self, state: MenuState, *, step: Optional[int] = None) -> list[dict[str, Any]]:
        ...
        if state.dish_list:
            for event in new_events:
                ...
                if task_id is None or not note_id:
                    continue
                self._attach_note_to_task(state.dish_list, task_id, note_id)
    ...
    # Internal helpers
    # ------------------------------------------------------------------
    def _attach_note_to_task(self, tasks: list[DishItem], task_id: int, note_id: str) -> None:
